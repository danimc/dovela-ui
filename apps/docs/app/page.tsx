...
import { Button, Card, CardBody, CardHeader } from "@dovela-ui/react";
  ...
  return (
    <div className="space-y-14">
      <section className="space-y-5">
        <h1 className="text-4xl font-semibold tracking-tight">Dovela UI</h1>
        ...
        <CodeBlock code={"pnpm add @dovela-ui/react @dovela-ui/core"} />
      </section>
